...
/* maiora list */
    ...
    INSERT INTO opera_maiora_temp
    (author_id, work_id, date_display, abbr, full, bibliography, comment, author_sort, work_sort, search, gq_work_id, gq_author_id, viaf_id, gnd_id, cc_idno, wikidata_id, same_line)
        SELECT
            author.id,
            work.id,
            work.date_display,
    ...
    INSERT INTO opera_maiora_temp
    (author_id, date_display, abbr, full, comment, author_sort, work_sort, gq_author_id, viaf_id, gnd_id, cc_idno, wikidata_id)
        SELECT author.id, author.date_display, IF(author.in_use != 1, CONCAT('[', author.abbr, ']'), author.abbr), author.full, author.txt_info, author.abbr_sort, "", author.gq_id, author.VIAF, author.GND, author.cc_idno, author.wikidata_id
        FROM author
    ...
    (author_id, work_id, date_display, abbr, full, search, bibliography, comment, editions_id, editions_url, editions_label, gq_work_id, gq_author_id, viaf_id, gnd_id, cc_idno, wikidata_id, same_line)
        SELECT author_id, work_id, date_display, abbr, full, search, bibliography, comment, editions_id, editions_url, editions_label, gq_work_id, gq_author_id, viaf_id, gnd_id, cc_idno, wikidata_id, same_line
...
/* opera minora */
    ...
    (author_id, work_id, date_display, citation, bibliography, search, editions_id, editions_url, editions_label, gq_work_id, gq_author_id, viaf_id, gnd_id, cc_idno, wikidata_id)
        SELECT author_id, work_id, date_display, citation, bibliography, search, editions_id, editions_url, editions_label, gq_work_id, gq_author_id, viaf_id, gnd_id, cc_idno, wikidata_id
