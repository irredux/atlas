...
def autoSetZettelType():
    zettelLst = db.search("zettel", {"ocr_text": ">"}, ["id", "type", "ocr_text"])
    zettelData = []
    for zettel in zettelLst:
...
def import_mgh2():
    ...
    setup_MGH_ressource( # ACERB. MOR. hist. 130–76
        "https://www.dmgh.de/mgh_ss_rer_germ_n_s_7/img/150/mgh_ss_rer_germ_n_s_7_",
...
def import_mgh():
    ...
    setup_MGH_ressource( # ARBO SANGERM. bell. 77–122
        "https://www.dmgh.de/mgh_poetae_4_1/img/150/mgh_poetae_4_1_",
